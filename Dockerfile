...
RUN pip install --no-cache-dir "datasets==2.19.0" "transformers==4.40.1" "easy-tpp==0.0.7.1" "wandb" "duckdb"
...
RUN git clone https://github.com/ivan-chai/torch-linear-assignment.git && cd torch-linear-assignment && \
